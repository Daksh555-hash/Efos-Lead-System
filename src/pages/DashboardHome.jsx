...
function DashboardHome() {
  ...
  const exportHeaders = ['Name', 'Email', 'Phone', 'City', 'Age', 'Qualification', 'Course Interested', 'Brochure', 'Visits', 'Source', 'Status', 'Score', 'Submitted On']
  ...
  const handleExportCSV = () => exportToCSV(exportHeaders, exportRows(), `EFOS_Student_Data_Export_${Date.now()}.csv`)
  const handleExportExcel = () => exportToExcel([{ name: 'Student Data', headers: exportHeaders, rows: exportRows() }], `EFOS_Student_Data_Export_${Date.now()}.xlsx`)
